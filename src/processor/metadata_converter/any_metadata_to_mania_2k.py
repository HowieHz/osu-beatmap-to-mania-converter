from ._any_metadata_to_mania import _any_metadata_to_mania


def any_metadata_to_mania_2k(osu_file_metadata: list[str]) -> list[str]:
    """将 osu 铺面的元数据转换成 osu!mania 2k 的元数据\n
    1. 设置 Mode 标识为 mania\n
    2. 设置 CircleSize 为 2\n
    ...
    for line in osu_file_metadata:
        if line.startswith("CircleSize:"):
            osu_file_metadata[osu_file_metadata.index(line)] = "CircleSize:2\n"
            break
